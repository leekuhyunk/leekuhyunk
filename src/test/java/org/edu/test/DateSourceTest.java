...
@WebAppConfiguration
public class DateSourceTest {//자바에서처럼 new 오브젝트를 생성하지않고, 스프링에서는@Inject로 오브젝트 생성.
	...
	public void updateMember() throws Exception {
		//CRUD 중 update 테스트 구현 특징, user_id는 프라이머리키 이기 때문에 수정 대상이 아닙니다.
	...
	public void deleteMember() throws Exception {
		...
		memberDAO.deleteMember("user_20201215151926139");//삭제메서드 -> 쿼리 호출
	}
	...
	public void dbConnectionTest() throws Exception { 
		try {//내부에서 {} 에러발생시 실행을 중지하고, catch{}구문이 실행 됩니다. 예외처리라 합니다.
