          ...
          <ul class="users-list clearfix">
            ...
            <a class="users-list-name" href="/admin/member/member_view?page=1&user_id=${memberVO.user_id}">
              ...
              <img src="/resources/dist/img/default-150x150.png" alt="User Image">
               -->
              <img onerror="this.src='/resources/dist/img/default-150x150.png'" alt="User Image" src="/resources/profile/${memberVO.user_id}.jpg" alt="사용자프로필" style="width:120px;height:120px;" />
              <div>
              ${memberVO.user_name}           
...
$(document).ready(function(){
	$("img").error(function(){
		$("img").attr("src","/resources/dist/img/default-150x150.png");
	});
});
</script>