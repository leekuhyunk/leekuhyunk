 ...
 * hyyp://localhost"8080/ 요청을 받았을때, 변수를 만들어서 화면에 뿌려준다.
 */
@Controller
public class HomeController {
	...
	public String home(Locale locale, Model model) {
		...
		System.out.println("위에 Locale 클래스를 사용하는 이유는 다국어 지원때문에 변수로 사용하게 됩니다.");
		...
		Date date = new Date();//Date 날짜관련 클래스형 변수 date 선언했습니다.date 변수 메서드를 사용 가능하게됨
		//date 변수 실행가능한 변수=클래스형변수=Object오브젝트=인스턴스 라고 합니다.(위)
		...
		//스프링에서 데이터 이동(전송)에 대해서 살펴 보았습니다.
	}*/
